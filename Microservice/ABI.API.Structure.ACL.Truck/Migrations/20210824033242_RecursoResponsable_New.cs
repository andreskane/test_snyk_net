...
{
    public partial class RecursoResponsable_New : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    recurso_responsableo_id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    recurso_responsable_recurso_id = table.Column<int>(type: "int", nullable: false),
                    ...
                    recurso_responsable_paisId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Recurso_responsable", x => x.recurso_responsableo_id);
                });
        }
