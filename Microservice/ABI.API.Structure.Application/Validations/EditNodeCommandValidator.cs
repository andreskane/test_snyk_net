...
{
    public class EditNodeCommandValidator : AbstractValidator<EditNodeCommand>
    {
        ...
        public EditNodeCommandValidator(IStructureNodeRepository repositoryStructureNode, IAttentionModeRoleRepository attentionModeRoleRepo)
        {
