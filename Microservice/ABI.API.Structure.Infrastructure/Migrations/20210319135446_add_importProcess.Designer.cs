...
namespace ABI.API.Structure.Infrastructure.Migrations
{
    ...
    [Migration("20210319135446_add_importProcess")]
    partial class add_importProcess
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.EstructuraClienteTerritorioIO", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("estruct_territorio_io","dbo");
                });

            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ImportProcess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<decimal?>("AverageDailySale")
                        .HasColumnName("proceso_importacion_venta_promedio_diario")
                    ...
                    b.ToTable("proceso_importacion","dbo");
                });
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.PeriodicityDays", b =>
                {
                    b.Property<int>("Id")
                    ...
                    b.ToTable("dias_periodicidad","dbo");
                });
