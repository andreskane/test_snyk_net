...
namespace ABI.API.Structure.Infrastructure.Migrations
{
    ...
    [Migration("20201022192955_ALter_Table_LodImpactTruck")]
    partial class ALter_Table_LodImpactTruck
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.ImpactStatus", b =>
                {
                    b.Property<int>("Id")
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruck", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruckArista", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruckNode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruckStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.TypeVendorTruckPortal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruckArista", b =>
                {
                    b.HasOne("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruck", "LogImpactTruck")
            ...
            modelBuilder.Entity("ABI.API.Structure.Domain.Entities.ACL.LogImpactTruckStatus", b =>
                {
                    ...
                    b.HasOne("ABI.API.Structure.Domain.Entities.ACL.ImpactStatus", "Status")
                        .WithMany("LogsImpactTruckStatus")
