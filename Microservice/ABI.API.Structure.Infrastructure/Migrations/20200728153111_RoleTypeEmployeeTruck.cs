...
namespace ABI.API.Structure.Infrastructure.Migrations
{
    ...
    public partial class RoleTypeEmployeeTruck : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    rol_tipo_empleado_id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    rol_id = table.Column<int>(nullable: false),
                    tipo_empleado_truck_id = table.Column<string>(maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
