...
{
    [TestClass()]
    public class PortalStructureNodeDTOTests
    {
        [TestMethod()]
        public void PortalStructureNodeDTOTest()
        {
            var result = new PortalStructureNodeDTO();
            ...
            result.NodeValidityTo = DateTimeOffset.UtcNow.Date;
            ...
            result.NodeValidityTo.Should().Be(DateTimeOffset.UtcNow.Date);
